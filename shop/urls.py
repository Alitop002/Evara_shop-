...
from shop.views import dahsboard,detail,ProfileUserView,cart,compare,LoginUserView,shop,logout_view,get_product_view_category,register_user,cart_page,wishilst,GetChekoutPageView,ChangePassword
urlpatterns = [
    path('', dahsboard, name='dashboard'),
    path('detail/', detail, name='detail'),
    path('profile/',ProfileUserView.as_view() , name='accounts'),
